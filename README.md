...
- [Angular](https://angular.dev/) 19 (Standalone Components + Signals)
- [Capacitor](https://capacitorjs.com/) (empaquetado para Android)
- TypeScript, SCSS
...
4. Abrir en el navegador: `http://localhost:8100`
...
Santiago Riaño — Estudiante de Ingeniería de Sistemas, Escuela Tecnológica Instituto Técnico Central (ETITC)
